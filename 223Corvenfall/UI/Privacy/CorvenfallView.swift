...
import SwiftUI
    ...
    public class CorvenfallUpdateManagerSceneController: UIViewController,
        ...
        public func CorvenfallUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if CorvenfallUpdateManager.shared.CorvenfallUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                CorvenfallUpdateManager.shared.CorvenfallUpdateManagerFinal = finalUrl
        ...
        public func CorvenfallUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func CorvenfallUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func CorvenfallUpdateManagerToggleNavBar() {
